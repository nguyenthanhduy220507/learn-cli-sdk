...
echo "  3. Quan sát CI chạy trong tab 'Checks' của PR"
echo ""
echo "Kết quả mong đợi:"
echo "  Job 1 (test)            → ✅ PASS"
echo "  Job 2 (build-and-push)  → ✅ BUILD thành công nhưng KHÔNG push"
...
echo "  docker pull ghcr.io/YOUR_ORG/mycli:pr-HEAD"
